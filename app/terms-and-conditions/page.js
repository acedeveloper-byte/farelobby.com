            ...
            <div className="row g-4 align-items-center">
              <div className="col-lg-12 main-content">
                <div className="section-title">
                  <span className="wow fadeInUp">Terms and Conditions - FareLobby</span>
                </div>
                <p>
                  Welcome to FareLobby! By using our website and services, you agree to be bound by the following
                ...
                <ol> 
                  ...
                  <p>
                    ...
                    www.farelobby.com (the "Site") and the services offered by FareLobby ("Services"). By accessing or 
                  ...
                  <p>
                    FareLobby reserves the right to revise these Terms and Conditions at any time. Any changes will be posted 
                    on this page, and the "Last Updated" date at the top of this page will reflect the latest revision. 
                    By continuing to access or use FareLobby after any modifications, you agree to comply with the updated terms.
                  </p>

                  <li><strong>Services Provided</strong></li>
                  <p>
                    FareLobby acts as an intermediary platform that provides access to airline-related services including, 
                    but not limited to, booking flights, purchasing tickets, and offering information on airline options. 
                    FareLobby is not an airline itself but rather a third-party service provider connecting users to airlines and travel partners.
                  </p>

                  <li><strong>Account Registration</strong></li>
                  <p>
                    In order to access certain features of the Site, you may be required to create an account with FareLobby. 
                  ...
                  <p>
                    When you make a booking through FareLobby, you are entering into an agreement with the airline or travel 
                    provider offering the service. FareLobby will facilitate the booking process and may charge fees for 
                    services rendered, such as booking fees or processing charges.
                  </p>
                  <p>
                    FareLobby is not responsible for any errors, cancellations, or disputes between you and the airline 
                  ...
                  <p>
                    FareLobby values your privacy. Please review our Privacy Policy to understand how we collect, use, 
                    and protect your personal information.
                  </p>

                  <li><strong>Limitation of Liability</strong></li>
                  <p>
                    To the fullest extent permitted by law, FareLobby and its affiliates shall not be liable for any 
